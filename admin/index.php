...
<body>
    ...
    <div class="splash-container">
        <div class="card rounded">
            <div class="card-header text-center rounded"><a href="#">
                    <h2 class="text-brown">ADMIN</h2>
                </a><span class="splash-description">Please enter the admin credentials.</span></div>
            <div class="card-body ">
                <form id="form" data-parsley-validate="" method="post" action="login_check.php">
                    ...
                    <button type="submit" class="btn btn-outline-dark rounded btn-lg btn-block">Sign in</button>
                </form>
            </div>
            <div class="card-footer bg-white p-0 rounded text-center">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="admin_signup.php" class="footer-link text-brown">Create An Account</a>
                </div>
                <!-- <div class="card-footer-item card-footer-item-bordered">
