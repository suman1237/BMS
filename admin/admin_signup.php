        ...
        <div class="card rounded">
            ...
            <div class="card-body">
                ...
                <div class="form-group pt-2">
                    <button class="btn btn-block btn-outline-dark rounded" type="submit">Register</button>
                </div>
            </div>
            <div class="card-footer bg-white rounded text-center">
                <p>Already member? <a href="index.php" class="footer-link text-brown">Login Here.</a></p>
            </div>
        </div>
    </form>
